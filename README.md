...
## Aims
- To create application with a HTML structure, CSS styling, and JavaScript interactivity
...
-  to delete a mistyped digit easily
<br />

### As a returning visitor, I want to:
- be able to explore a scientific functionality of the application
- to have an indication of the operations’ history
